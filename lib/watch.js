...
module.exports = (config) => {
  // const ignore = config.MarkconfDefaults.watch.ignore || ['.DS_Store', '.git', '.gitignore', 'node_modules']
  // const ignore = ['.DS_Store', '.git', '.gitignore', 'node_modules', 'Library', 'Music']
  const ignore = [/(^|[\/\\])\../, /node_modules/, /Library/, /Music/]
  let watcher
