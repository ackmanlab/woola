...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="http://${flags.address}:${httpPort}/css/favicon.png">
  <link rel="stylesheet" href="${site.cssURI}">
  <link rel="stylesheet" href="http://${flags.address}:${httpPort}/css/katex.min.css">
  <link rel="stylesheet" href="http://${flags.address}:${httpPort}/css/styles/base16/github.min.css">
  <script src="http://${flags.address}:${httpPort}/css/highlight.min.js"></script>
