...
const markdownExtensions = [ '.markdown', '.md', '.mmd', '.mdtxt', '.txt' ]
const watchExtensions = markdownExtensions.concat([ '.less', '.sass', 'scss', '.js', '.css', '.html', '.htm', '.json', '.gif', '.png', '.jpg', '.jpeg' ])
...
// watchConfig.MarkconfDir = process.cwd()
