...
//         path: outfilename, 
//         format: 'Letter',
//         headerTemplate : '<div id="header-template" style="font-size:10px !important; color:#808080; width:100%; padding-left:50px; text-align:left">James_________________________</div><div class="title" style="font-size:10px !important; color:#808080; width:100%; padding-right:50px; text-align:right"></div>',
//         footerTemplate : '<div id="footer-template" style="width:100%; text-align:right; font-size:10px !important; color:#808080; padding-right:50px"><span class="pageNumber"></span>/<span class="totalPages"></span></div>',
...
//   //     pdfconfig.outfilename = outfilename
//   //   }
//   // }
// 
