...
module.exports = function writepdf(uri, outfilename, config=null) {
  ...
  if (!config) {
    const pdfconfig = {
        path: outfilename, 
        format: 'Letter',
        headerTemplate : '<div id="header-template" style="font-size:10px !important; color:#808080; width:100%; padding-left:50px; text-align:left">Name_________________________</div><div class="title" style="font-size:10px !important; color:#808080; width:100%; padding-right:50px; text-align:right"></div>',
