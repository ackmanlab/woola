...
`<head>
  ...
  <link rel="stylesheet" href="https://ackmanlab.com/css/main.css">
...
pushBananaSlugIcon: function (site, icons) {
  ...
  if (site.local_url) {
    return (
      `<a class="post-link" href="${site.local_url}"><span>Local</span><span class="coloricon">${this.icons.bananaslug}</span></athis.>`
    )
  } else {
    return ''
  }
