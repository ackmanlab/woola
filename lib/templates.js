...
<h2>
${(site.options.categories[p.categories[0]] && site.options.categories[p.categories[0]]['icon']) ? `<span class="coloricon">${this.icons[site.options.categories[p.categories[0]]['icon']]}</span>` : ''}<a class="post-link" href="${site.baseurl + p.url}">${p.title}</a>
</h2>
</li>`
