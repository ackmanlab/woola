...
//     cssURI = path.resolve('/', baseDir, cssURI)
//   } catch (err) {
//     if ( ("css" in siteConfig) && (siteConfig["css"].startsWith('http')) ) {
//       cssURI = siteConfig["css"]
//       console.log('1using: ' + cssURI)
//     } else if ( ("css" in siteConfig) ) {
//       try {
//         fs.statSync(path.resolve(rootDir,siteConfig["css"])).isFile()
//         cssURI = siteConfig["css"]
//         console.log('2using: ' + cssURI)
//       } catch (err)  {
//         console.log(err + ' , 3using: ' + cssURI)
//       }
//     } else {
//       console.log('using: ' + cssURI)
//     }
//     console.log(err + ' , 4using: ' + cssURI)
//   }
// }
